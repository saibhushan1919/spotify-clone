...
const AddSong = () => {
        ...
        const onSubmitHAndler = async (e) => {
            ...
            try {
                ...
                const responde = await axios.post('${url}/api/song/add',formData);
    ...
    return loading ? (
        <div className='grid place-itmes-center min-h-[80vh]'>
        ...
        <form onSubmit={onSubmitHAndler} className='flex flex-col items-start gap-8 text-gray-600'>
            <div className='flex gap-8'>
                ...
                <div className='flex flex-col gap-4'>
                    ...
                    <label htmlFor="image">
                        <img src={ image ? URL.createObjectYRL(image) : assets.upload_area} className='w-24 cursor-pointer' alt="" />
                    </label>
                </div>
            </div>
